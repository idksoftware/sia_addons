...
public class Metadata {
	...
	GPSProperties gpsProperties = new GPSProperties();
	CopyrightProperties copyrightProperties = new CopyrightProperties();
	...
	/**
	 * @param mediaProerties the mediaProerties to set
	 */
	public void setMediaProperties(MediaProperties mediaProerties) {
		this.mediaProperties = mediaProerties;
	}

	/**
	 * @return the cameraInformation
	 */
	...
	/**
	 * @param cameraInformation the cameraInformation to set
	 */
	...
	/**
	 * @param gpsProperties the gpsProperties to set
	 */
	public void setGpsProperties(GPSProperties gpsProperties) {
		this.gpsProperties = gpsProperties;
	}

	/**
	 * @return the copyrightProperties
	 */
	public CopyrightProperties getCopyrightProperties() {
		return copyrightProperties;
	}

	/**
	 * @param copyrightProperties the copyrightProperties to set
	 */
	public void setCopyrightProperties(CopyrightProperties copyrightProperties) {
	...
	class AssetProperties {
		...
		/**
		 * @return the orginalName
		 */
		public String getOrginalName() {
			return orginalName;
		}
		/**
		 * @param orginalName the orginalName to set
		 */
	...
	public class MediaProperties {
		...
		private String primaryEncoding;
		/**
		 * @return the width
		 */
		...
		/**
		 * @return the primaryEncoding
		 */
		public String getPrimaryEncoding() {
			return primaryEncoding;
		}
		/**
		 * @param primaryEncoding the primaryEncoding to set
		 */
		public void setPrimaryEncoding(String primaryEncoding) {
	...
	class CameraInformation {
		...
		/**
		 * @param exifVersion the exifVersion to set
		 */
		...
		/**
		 * @param meteringMode the meteringMode to set
		 */
	...
	class CopyrightProperties {
		...
		/**
		 * @return the usageRights
		 */
		public String getUsageRights() {
			return usageRights;
		}
		/**
		 * @param usageRights the usageRights to set
		 */
