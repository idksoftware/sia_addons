...
public class HistoryScene extends Scene {
    ...
    public HistoryScene(Group group) {
		super(group);
        ...
        versionCol.setCellValueFactory(
                new PropertyValueFactory<HistoryScene, String>("Version"));
 
        TableColumn dateCol = new TableColumn("Date");
        dateCol.setMinWidth(150);
        dateCol.setCellValueFactory(
                new PropertyValueFactory<HistoryScene, String>("Date"));
 
        TableColumn commentCol = new TableColumn("Comment");
        commentCol.setMinWidth(200);
        commentCol.setCellValueFactory(
                new PropertyValueFactory<HistoryScene, String>("Comment"));
