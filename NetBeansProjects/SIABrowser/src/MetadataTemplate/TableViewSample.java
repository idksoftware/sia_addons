...
public class TableViewSample extends Application {
    ...
    private final ObservableList<KeyValueItem> data =
            ...
            new KeyValueItem("Jacob", "Smith"),
            new KeyValueItem("Isabella", "Johnson"),
            new KeyValueItem("Ethan", "Williams"),
    ...
    public void start(Stage stage) {
        ...
        firstNameCol.setCellValueFactory(
            new PropertyValueFactory<KeyValueItem, String>("firstName"));
        ...
        lastNameCol.setCellValueFactory(
            new PropertyValueFactory<KeyValueItem, String>("lastName"));
 ...
 /*
        ...
        emailCol.setCellValueFactory(
            new PropertyValueFactory<KeyValueItem, String>("email"));
 ...
 */
    ...
    public static class KeyValueItem {
        ...
        private KeyValueItem(String fName, String lName) { //, String email) {
