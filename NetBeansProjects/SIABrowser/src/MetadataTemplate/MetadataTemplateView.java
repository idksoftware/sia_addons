...
import MetadataTemplate.PropertiesView.KeyValueItem;
...
public class MetadataTemplateView extends TableView<MetadataTemplateView.KeyValueItem> {
	 
    //private TableView<KeyValueItem> table = new TableView<KeyValueItem>();
    //private ObservableList<KeyValueItem> data = null;
    private ObservableList<KeyValueItem> data =
    ...
    void setData(ObservableList<MetadataTemplateView.KeyValueItem> data) {
    	this.data = data;
    }
